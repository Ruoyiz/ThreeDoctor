...
@property (nonatomic, copy, readwrite) returnBlock onReturnBlock;
...
- (void)requestLoginWithThirdType:(LXMThirdLoginType)thirdLoginType
                    onReturnBlock:(returnBlock)aReturnBlock
                    completeBlock:(LXMThirdLoginCompleteBlock)completeBlock
{
    self.onReturnBlock = aReturnBlock;
